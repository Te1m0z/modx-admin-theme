...
{$_lang.dashboard}">{$_lang.dashboard}</a>
                ...
                <li id="modx-site-info">
                    ...
                    <div class="info-item full_appname">
						<a href="https://site-creative.ru" target="_blank">site-creative.ru</a>
					</div>
                </li>
                {if $_search}
				...
				<li>
					<a href="?a=home&amp;namespace=clientconfig">Конфигурация</a>
				</li>
				<li>
					<a href="{$_config.denta_instruction}" target="_blank">Инструкция</a>
				</li>
            </ul>
            {if $_search}
